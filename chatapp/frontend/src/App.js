        ...
        <div className="App">
            ...
            <div className="inputArea">
                ...
                >
                    ...
                    <option value={`http://${hostname}:8000/prompt-leaking-lv2/`}>Leak Lv.2 (input/output regex filter)</option>
                    ...
                    <option value={`http://${hostname}:8000/p2sql-injection-lv3/`}>SQLi Lv.3 (defensive system prompt)</option>
                    ...
                    <option value={`http://${hostname}:8000/llm4shell-lv1/`}>LLM4Shell Lv.1 (no guard)</option>
                    <option value={`http://${hostname}:8000/llm4shell-lv2/`}>LLM4Shell Lv.2 (input/output regex filter)</option>
